...
#define HAVE_BLK_QUEUE_SECDISCARD 1
...
#define HAVE_MAKE_REQUEST_FN_RET_VOID 1
...
#define HAVE_REQ_DISCARD 1

/* REQ_FLUSH is defined */
#define HAVE_REQ_FLUSH 1
...
#define HAVE_VFS_DIRECT_IO_ITER_OFFSET 1
...
#define ZFS_META_ALIAS "zfs-2.1.6-1"
