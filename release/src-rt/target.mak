...
export RT-AC86U += BUILD_NAME="RT-AC86U" NVSIZE="128" DHDAP=y DPSTA=y LACP=n WTFAST=y REPEATER=y \
				...
				IPSEC=STRONGSWAN IPSEC_SRVCLI_ONLY=SRV DFS_US=y ALEXA=n IFTTT=n COMFW=y \
				OPEN_NAT=y SW_CTRL_ALLLED=y AHS=n ASD=y FRS_LIVE_UPDATE=n INSTANT_GUARD=y PC_SCHED_V3=y GAME_MODE=y \
				BCMEVENTD=y BCM_APPEVENTD=y JFFS_NVRAM=y LETSENCRYPT=y WIREGUARD=y ASUSCTRL=y JFFS_NVRAM_HND_OLD=y \
				VISUALIZATION=y NFS=y SNMPD=n TOR=y UPNPIGD2=n NANO=y NTPD=y ZFS=y
...
export GT-AC2900 += BUILD_NAME="GT-AC2900" NVSIZE="128" DHDAP=y DPSTA=y LACP=y WTFAST=y REPEATER=y \
				...
				ASUSCTRL=y JFFS_NVRAM_HND_OLD=y COMFW=y \
...
export RT-AX88U += BUILD_NAME="RT-AX88U" SWITCH2="BCM53134" NVSIZE="128" DHDAP=y DPSTA=y LACP=y WTFAST=y REPEATER=y \
		...
		SYSSTATE=y ROG=n STAINFO=y CLOUDCHECK=n NATNL_AICLOUD=y REBOOT_SCHEDULE=y MULTICASTIPTV=y QUAGGA=y JFFS_NVRAM_HND_OLD=y \
		...
		NFS=y SNMPD=n TOR=y UPNPIGD2=n NANO=y NTPD=y ZFS=y
...
export GT-AX11000 += BUILD_NAME="GT-AX11000" EXT_PHY="BCM84880" SWITCH2="" NVSIZE="128" DHDAP=y DPSTA=y LACP=y WTFAST=y REPEATER=y \
		...
		IPV6S46=y JFFS_NVRAM_HND_OLD=y COMFW=y \
		NFS=y SNMPD=n TOR=y UPNPIGD2=n NANO=y NTPD=y ZFS=y


export HND-963178_BASE := HND_ROUTER=y PROFILE="96750GW" SAMBA3="3.6.x" OOKLA=y WL_SCHED_V3=y HND_ROUTER_AX_675X=y
...
export RT-AX58U += BUILD_NAME="RT-AX58U" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y SW_CTRL_ALLLED=y \
		...
		ACL96=y GOOGLE_ASST=y COMFW=n WIREGUARD=y IPV6S46=y HND_ROUTER_AX_675X=y JFFS_NVRAM_HND_OLD=y \
		NFS=y SNMPD=n TOR=y UPNPIGD2=n NANO=y NTPD=y ZFS=y

export HND-947622_BASE := HND_ROUTER=y PROFILE="947622GW" SAMBA3="3.6.x" OOKLA=y WL_SCHED_V3=y HND_ROUTER_AX_675X=y
...
export RT-AX56U += BUILD_NAME="RT-AX56U" SWITCH2="BCM53134" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y SW_CTRL_ALLLED=y \
		...
		ACL96=y GOOGLE_ASST=y ASUSCTRL=y WIREGUARD=y IPV6S46=y HND_ROUTER_AX_675X=y JFFS_NVRAM_HND_OLD=y COMFW=y \
		NFS=y SNMPD=n TOR=y UPNPIGD2=n NANO=y NTPD=y ZFS=y
...
export RT-AX86U += BUILD_NAME="RT-AX86U" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y HND_WL=y \
		...
		JFFS_NVRAM_HND_OLD=y ACL96=y GOOGLE_ASST=y EXTEND_LIMIT=y ASUSCTRL=y WIREGUARD=y \
		NFS=y SNMPD=y TOR=y UPNPIGD2=n NANO=y NTPD=y ZFS=y
...
export RT-AX68U += BUILD_NAME="RT-AX68U" NVSIZE="128" DHDAP=n HND_WL=y DPSTA=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y \
		...
		ACL96=y GOOGLE_ASST=y WIREGUARD=y HND_ROUTER_AX_6710=y JFFS_NVRAM_HND_OLD=y COMFW=y \
		NFS=y SNMPD=y TOR=y UPNPIGD2=n NANO=y NTPD=y ZFS=y
...
export RT-AC68U_V4 += BUILD_NAME="RT-AC68U_V4" NVSIZE="128" DHDAP=n HND_WL=y DPSTA=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y \
                      ...
                      HND_ROUTER_AX_6710=y JFFS_NVRAM_HND_OLD=y COMFW=n \
                      NFS=y SNMPD=n TOR=y UPNPIGD2=n NANO=y NTPD=y DNSPRIVACY=y VISUALIZATION=y ZFS=y
...
export GT-AXE11000 += BUILD_NAME="GT-AXE11000" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y DPSTA=y REPEATER=y IPV6SUPP=y \
                      ...
                      BCN_RPT=y BTM_11V=y INTERNETCTRL=y ASD=y AHS=n FRS_LIVE_UPDATE=n HAS_5G_2=y CAPTCHA=y WIFI6E=y \
                      GAME_MODE=y AMAS_ETHDETECT=y INSTANT_GUARD=y AVBLCHAN=y FRONTHAUL_DWB=y OWE_TRANS=y HSPOT=y ACL96=y \
                      GOOGLE_ASST=y EXTEND_LIMIT=y WIREGUARD=y HND_ROUTER_AX_6710=y JFFS_NVRAM_HND_OLD=y COMFW=y \
                      NFS=y SNMPD=n TOR=y UPNPIGD2=n NANO=y NTPD=y DNSPRIVACY=y ZFS=y
...
export GT-AX6000 += BUILD_NAME="GT-AX6000" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y DPSTA=n REPEATER=y IPV6SUPP=y \
		...
		ACCEL_PPTPD=y PRINTER=y WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="installed" PROXYSTA=y \
		...
		JFFS_NVRAM_HND_OLD=y NVRAM_ENCRYPT=y NATNL_AIHOME=y LOGO_LED=n BCM_CEVENTD=y UTF8_SSID=y \
		...
		WIREGUARD=y COMFW=y \
		NFS=y SNMPD=y TOR=y UPNPIGD2=n NANO=y NTPD=y DNSPRIVACY=y IPSET=y
...
export XT12 += BUILD_NAME="XT12" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y \
		BBEXTRAS=y USBEXTRAS=y EBTABLES=y XHCI=y PARENTAL2=y ACCEL_PPTPD=y USB="USB" APP="installed" PROXYSTA=y \
		...
		NVRAM_ENCRYPT=y BCM_CEVENTD=y UTF8_SSID=y I2CTOOLS=y AMAS=y DBLOG=y ETHOBD=y CFGSYNC_LOCSYNC=y \
		...
		MSSID_PRELINK=y EXTEND_LIMIT=y GOOGLE_ASST=y VPN_FUSION=n AMAS_ADTBW=y BONDING=y VISUALIZATION=y \
		WIREGUARD=y \
		NFS=n SNMPD=y TOR=y UPNPIGD2=n NANO=y NTPD=y DNSPRIVACY=y IPSET=y
...
export GT-AXE16000 += BUILD_NAME="GT-AXE16000" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y DPSTA=n REPEATER=y IPV6SUPP=y HTTPS=y \
		...
		WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="installed" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y BCMWL6A=y \
		...
		CRASHLOG=y WATCH_REINIT=n BW160M=y BRCM_HOSTAPD=y UUPLUGIN=n IPERF3=y INFO_EXAP=y BCN_RPT=y BTM_11V=y \
		...
		BCMBSD_V2=y SW_CTRL_ALLLED=y AMAS_CENTRAL_CONTROL=y COMFW=y \
		VISUALIZATION=y WIREGUARD=y \
		NFS=y SNMPD=y TOR=y UPNPIGD2=n NANO=y NTPD=y DNSPRIVACY=y IPSET=y
...
export GT-AX11000_PRO += BUILD_NAME="GT-AX11000_PRO" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y DPSTA=n REPEATER=y IPV6SUPP=y \
		...
		WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="installed" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y BCMWL6A=y DISK_MONITOR=y \
		...
		SW_CTRL_ALLLED=y COMFW=y GOOGLE_ASST=y \
		VISUALIZATION=y WIREGUARD=y \
		NFS=y SNMPD=y TOR=y UPNPIGD2=n NANO=y NTPD=y DNSPRIVACY=y IPSET=y
